...
Q_CONSTINIT static const uint qt_meta_data_CLASSClientENDCLASS[] = {
 ...
 // enum data: key, value
       4, uint(Client::ACTIF),
       5, uint(Client::INACTIF),
       6, uint(Client::SUSPENDU),
...
Q_CONSTINIT const QMetaObject Client::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_stringdata_CLASSClientENDCLASS_t,
        // enum 'Statut'
        QtPrivate::TypeAndForceComplete<Client::Statut, std::true_type>,
        // Q_OBJECT / Q_GADGET
...
void Client::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_t _q_method = &Client::dataChanged; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
